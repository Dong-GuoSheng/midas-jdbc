...
public class MidasHttpClientBuilderTest {
    ...
    public void testCreateClientContextNull() {
        assertNull(MidasHttpClientBuilder.createClientContext(null).getAuthCache());
    }

    @Test
    public void testCreateClientContextNoUserNoPass() {
        assertNull(MidasHttpClientBuilder.createClientContext(new MidasProperties())
            .getAuthCache());
    }
    ...
    public void testCreateClientContextNoHost() {
        ...
        assertNull(MidasHttpClientBuilder.createClientContext(props).getAuthCache());
    }
    ...
    public void testCreateClientContextUserPass() {
        ...
        assertEquals(
            MidasHttpClientBuilder.createClientContext(props).getAuthCache()
        ...
        String password, String expectedAuthHeader) throws Exception
    {
        ...
        CloseableHttpClient client = new MidasHttpClientBuilder(props).buildClient();
        HttpPost post = new HttpPost(mockServer.baseUrl());
        client.execute(post, MidasHttpClientBuilder.createClientContext(props));
        mockServer.verify(
    ...
    public void testWithoutRetry() throws Exception {
        ...
        MidasHttpClientBuilder builder = new MidasHttpClientBuilder(props);
