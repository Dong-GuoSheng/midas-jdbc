...
public class MidasLZ4OutputStreamTest {
    private byte[] genCompressedByts(int b, int length, int blockSize) throws IOException {
        ...
        try (MidasLZ4OutputStream out = new MidasLZ4OutputStream(bas, blockSize)) {
    ...
    public void testWrite() throws IOException {
        ...
        try (MidasLZ4OutputStream out = new MidasLZ4OutputStream(bas, 2)) {
    ...
    public void testWriteBytes() throws IOException {
        Assert.assertThrows(NullPointerException.class, new Assert.ThrowingRunnable() {
            ...
            public void run() throws Throwable {
                try (MidasLZ4OutputStream out = new MidasLZ4OutputStream(new ByteArrayOutputStream(), 3)) {
                    out.write(null);
                }
            }
        });
        ...
        ByteArrayOutputStream bas = new ByteArrayOutputStream(64);
        try (MidasLZ4OutputStream out = new MidasLZ4OutputStream(bas, 3)) {
