...
public class BatchInsertsTest {
    ...
    public void testBatchInsert3() throws Exception {
        ...
        MidasPreparedStatementImpl statement = (MidasPreparedStatementImpl) connection.prepareStatement("INSERT INTO test.batch_insert3 (s, i) VALUES (?, ?), (?, ?)");
    ...
    public void batchInsertNulls() throws Exception {
        ...
        MidasPreparedStatement statement = (MidasPreparedStatement) connection.prepareStatement(
        ...
        statement.addBatch();
        statement.executeBatch(Collections.singletonMap(MidasQueryParam.CONNECT_TIMEOUT, "1000"));
