...
public class TimeZoneTest {
    private MidasConnection connectionServerTz;
    private MidasConnection connectionManualTz;
    private long currentTime = 1000 * (System.currentTimeMillis() / 1000);

    @BeforeTest
    public void setUp() throws Exception {
        MidasDataSource datasourceServerTz = MidasContainerForTest.newDataSource();;
        ...
        MidasDataSource dataSourceManualTz = MidasContainerForTest.newDataSource(properties);
