...
public class RowBinaryStreamTest {
    ...
    private void testRowBinaryStream(boolean rowBinaryResult) throws Exception {
        ...
        MidasStatement statement = connection.createStatement();
        ...
        if (!rowBinaryResult) {
            ...
            MidasRowBinaryInputStream is = connection.createStatement().executeQueryMidasRowBinaryStream("SELECT * FROM test.raw_binary ORDER BY date");
