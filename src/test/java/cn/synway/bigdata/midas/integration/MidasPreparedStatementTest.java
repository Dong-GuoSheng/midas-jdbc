...
import cn.synway.bigdata.midas.MidasPreparedStatement;
import cn.synway.bigdata.midas.MidasPreparedStatementImpl;
...
public class MidasPreparedStatementTest {
    ...
    public void testArrayTest() throws Exception {
        ...
        statement.setArray(2, new MidasArray(MidasDataType.Int32, new int[]{1, 2, 3}));
        statement.addBatch();

        statement.setInt(1, 2);
        statement.setArray(2, new MidasArray(MidasDataType.Int32, new int[]{2, 3, 4, 5}));
        statement.addBatch();
    ...
    public void testArrayOfNullable() throws Exception {
        ...
        statement.setArray(4, new MidasArray(MidasDataType.Int32, new Integer[]{1, null, 3}));
        statement.addBatch();
        statement.executeBatch();
        ...
        MidasDataSource configuredDataSource = new MidasDataSource(dataSource.getUrl(), properties);
        MidasConnection configuredConnection = configuredDataSource.getConnection();
    ...
    public void testArrayFixedStringTest() throws Exception {
        ...
        statement.setInt(1, 1);
        statement.setArray(2, new MidasArray(MidasDataType.FixedString, new byte[][]{randomEncodedUUID(), randomEncodedUUID()}));
        statement.addBatch();
    ...
    @Test
    public void testExecuteQueryMidasResponse() throws SQLException {
        MidasPreparedStatement sth = (MidasPreparedStatement) connection.prepareStatement("select ? limit 5");
        sth.setObject(1, 314);
        MidasResponse resp = sth.executeQueryMidasResponse();
        Assert.assertEquals(resp.getData(), singletonList(singletonList("314")));
    }

    @Test
    public void MidasJdbcFailsBecauseOfCommentInStart() throws Exception {
    ...
    public void testSetTime() throws Exception {
        MidasPreparedStatement stmt = (MidasPreparedStatement)
    ...
    public void testAsSql() throws Exception {
        ...
        MidasPreparedStatement statement = (MidasPreparedStatement)
    ...
    public void testInsertWithFunctions() throws Exception {
        ...
        String sql = stmt.unwrap(MidasPreparedStatementImpl.class).asSql();
        Assert.assertEquals(
            sql,
            "INSERT INTO test.insertfunctions(id, foo, bar) VALUES "
