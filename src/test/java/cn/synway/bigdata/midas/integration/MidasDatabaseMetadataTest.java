...
import cn.synway.bigdata.midas.MidasDatabaseMetadata;

public class MidasDatabaseMetadataTest {
    ...
    public void testDriverVersion() throws Exception {
        DatabaseMetaData metaData = new MidasDatabaseMetadata(
            "url", Mockito.mock(MidasConnection.class));
    ...
    public void testToDateTimeTZ() throws Exception {
        ...
        TimeZone timezone = ((MidasConnection) connection).getTimeZone();
