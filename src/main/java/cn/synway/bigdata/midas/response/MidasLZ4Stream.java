...
import cn.synway.bigdata.midas.util.MidasBlockChecksum;

import java.io.IOException;
import java.io.InputStream;

/**
 * Reader from Midas in lz4
 */

public class MidasLZ4Stream extends InputStream {
    ...
    public MidasLZ4Stream(InputStream stream) {
        this.stream = stream;
    ...
    private byte[] readNextBlock() throws IOException {
        ...
        MidasBlockChecksum expected = MidasBlockChecksum.fromBytes(checksum);
        // header:
        ...
        MidasBlockChecksum real = MidasBlockChecksum.calculateForBlock((byte)magic, compressedSizeWithHeader, uncompressedSize, block, compressedSize);
