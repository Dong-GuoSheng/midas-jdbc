...
public class MidasScrollableResultSet extends MidasResultSet {
    
    private List<ByteFragment[]> lines;

    public MidasScrollableResultSet(InputStream is, int bufferSize, String db, String table, boolean usesWithTotals, MidasStatement statement, TimeZone timezone, MidasProperties properties) throws IOException {
