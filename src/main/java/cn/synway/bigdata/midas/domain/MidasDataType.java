 ...
 * Midas, but for the sake of this driver, we treat these data types as
 * modifiers for the underlying base data types.
 */
public enum MidasDataType {
    ...
    MidasDataType(int sqlType, Class<?> javaClass,
    ...
    public static MidasDataType fromTypeString(String typeString) {
        String s = typeString.trim();
        for (MidasDataType dataType : values()) {
        ...
        return MidasDataType.Unknown;
    }

    public static MidasDataType resolveDefaultArrayDataType(String typeName) {
        for (MidasDataType chDataType : values()) {
            if (chDataType.name().equals(typeName)) {
                return chDataType;
            }
        }
        return MidasDataType.String;
    }
