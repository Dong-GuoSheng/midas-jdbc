...
import cn.synway.bigdata.midas.response.MidasColumnInfo;
import cn.synway.bigdata.midas.response.MidasResultBuilder;
import cn.synway.bigdata.midas.util.MidasVersionNumberUtil;


public class MidasDatabaseMetadata implements DatabaseMetaData {

    static final String DEFAULT_CAT = "default";

    private static final Logger log = LoggerFactory.getLogger(MidasDatabaseMetadata.class);

    private final String url;
    private final MidasConnection connection;

    public MidasDatabaseMetadata(String url, MidasConnection connection) {
        this.url = url;
    ...
    public int getDriverMajorVersion() {
        ...
        return MidasVersionNumberUtil.getMajorVersion(v);
    }
    ...
    public int getDriverMinorVersion() {
        ...
        return MidasVersionNumberUtil.getMinorVersion(v);
    }
    ...
    public ResultSet getProcedures(String catalog, String schemaPattern, String procedureNamePattern) throws SQLException {
        MidasResultBuilder builder = MidasResultBuilder.builder(9);
        builder.names(
                "PROCEDURE_CAT",
                "PROCEDURE_SCHEM",
                "PROCEDURE_NAME",
    ...
    public ResultSet getProcedureColumns(String catalog, String schemaPattern, String procedureNamePattern, String columnNamePattern) throws SQLException {
        MidasResultBuilder builder = MidasResultBuilder.builder(20);
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
        ...
        MidasResultBuilder builder = MidasResultBuilder.builder(10);
    ...
    public ResultSet getCatalogs() throws SQLException {
        MidasResultBuilder builder = MidasResultBuilder.builder(1);
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException {
        ...
        MidasResultBuilder builder = getMidasResultBuilderForGetColumns();
        ...
        while (descTable.next()) {
            ...
            //column name
            MidasColumnInfo columnInfo = MidasColumnInfo.parse(
                descTable.getString("type"),
                descTable.getString("name"));
            row.add(columnInfo.getColumnName());
            //data type
            row.add(String.valueOf(columnInfo.getMidasDataType().getSqlType()));
            //type name
    ...
    private MidasResultBuilder getMidasResultBuilderForGetColumns() {
        MidasResultBuilder builder = MidasResultBuilder.builder(24);
        builder.names(
                "TABLE_CAT",
                "TABLE_SCHEM",
                "TABLE_NAME",
    ...
    private ResultSet getEmptyResultSet() {
        return MidasResultBuilder.builder(1).names("some").types("String").build();
    }
    ...
    public ResultSet getTypeInfo() throws SQLException {
        MidasResultBuilder builder = MidasResultBuilder.builder(18);
        builder.names(
                "TYPE_NAME",
                "DATA_TYPE",
                "PRECISION",
    ...
    public int getDatabaseMajorVersion() throws SQLException {
        return MidasVersionNumberUtil.getMajorVersion(
            connection.getServerVersion());
    }

    @Override
    public int getDatabaseMinorVersion() throws SQLException {
        return MidasVersionNumberUtil.getMinorVersion(
            connection.getServerVersion());
    }
