...
public enum MidasConnectionSettings implements DriverPropertyCreator {
    ...
    * */
    DATA_TRANSFER_TIMEOUT( "dataTransferTimeout", 10000, "Timeout for data transfer. "
            + " socketTimeout + dataTransferTimeout is sent to Midas as max_execution_time. "
            + " Midas rejects request execution if its time exceeds max_execution_time"),
    ...
    MidasConnectionSettings(String key, Object defaultValue, String description) {
        this.key = key;
