...
public enum MidasQueryParam implements DriverPropertyCreator {
    ...
    /**
     * https://Midas.yandex/reference_en.html#Extreme values
     */
    ...
    /**
     * https://Midas.yandex/reference_en.html#max_block_size
     */
    ...
    /**
     * https://Midas.yandex/reference_en.html#max_execution_time
     */
    ...
    /**
     * @see <a href="https://Midas.yandex/reference_en.html#max_memory_usage">max_memory_usage</a>
     */
    ...
    /**
     * @see <a href="https://Midas.yandex/docs/en/operations/settings/query_complexity/#max-memory-usage-for-user">max_memory_usage_for_user</a>
     */
    ...
    /**
     * @see <a href="https://Midas.yandex/docs/en/operations/settings/query_complexity/#max-memory-usage-for-all-queries">max_memory_usage_for_all_queries</a>
     */
    ...
    /**
     * https://Midas.yandex/reference_en.html#max_rows_to_group_by
     */
    ...
    /**
     * https://Midas.yandex/reference_en.html#max_threads
     */
    ...
    /**
     * https://Midas.yandex/reference_en.html#Settings profiles
     */
    ...
    SEND_PROGRESS_IN_HTTP_HEADERS("send_progress_in_http_headers", null, Boolean.class, "Allow to populate summary in MidasStatement with read/written rows/bytes"),
    ...
    /**
     * https://Midas.yandex/reference_en.html#WITH TOTALS modifier
     */
    ...
    ENABLE_OPTIMIZE_PREDICATE_EXPRESSION("enable_optimize_predicate_expression", null, Boolean.class, "See Midas server description for this parameter. Default value is null so that server setting is taken."),
    ...
    <T> MidasQueryParam(String key, T defaultValue, Class<T> clazz, String description) {
        this.key = key;
