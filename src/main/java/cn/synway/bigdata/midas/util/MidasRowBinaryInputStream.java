...
import static cn.synway.bigdata.midas.util.MidasRowBinaryStream.MILLIS_IN_DAY;

public class MidasRowBinaryInputStream implements Closeable {
	private final LittleEndianDataInputStream in;
	private final TimeZone timeZone;

	public MidasRowBinaryInputStream(InputStream is, TimeZone timeZone, MidasProperties properties) {
