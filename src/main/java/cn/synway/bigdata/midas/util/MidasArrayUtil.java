 ...
 */
public class MidasArrayUtil {

    private MidasArrayUtil() {
        // NOP
    }

    /**
     * @param object
     *            the object to convert to Midas-string representation
     * @param dateTimeZone
    ...
    private static String toString(byte[] values) {
        return "'" + MidasValueFormatter.formatBytes(values) + "'";
    }
    ...
    private static boolean needQuote(Object[] objects) {
        ...
        return objects.length == 0 || MidasValueFormatter.needsQuoting(o);
    }
        ...
        private ArrayBuilder append(Object value) {
            ...
            if (value != null) {
                ...
                if (value instanceof String) {
                    builder.append(quote ? MidasUtil.escape((String) value) : value);
                } else {
                    builder.append(MidasValueFormatter.formatObject(
