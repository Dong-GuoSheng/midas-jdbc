...
import cn.synway.bigdata.midas.MidasUtil;
...
public final class MidasValueFormatter {
    ...
    public static String formatString(String myString) {
        return MidasUtil.escape(myString);
    }
        ...
        TimeZone dateTimeTimeZone)
    {
        ...
        if (x instanceof Byte) {
            ...
            return MidasArrayUtil.toString((Collection) x, dateTimeZone, dateTimeTimeZone);
        } else if (x.getClass().isArray()) {
            return MidasArrayUtil.arrayToString(x, dateTimeZone, dateTimeTimeZone);
        } else {
    ...
    private MidasValueFormatter() { /* NOP */ }
}
