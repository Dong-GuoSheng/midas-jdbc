...
public class MidasLZ4OutputStream extends OutputStream {
    ...
    public MidasLZ4OutputStream(OutputStream stream, int maxCompressBlockSize) {
    ...
    private void writeBlock() throws IOException {
        ...
        MidasBlockChecksum checksum = MidasBlockChecksum.calculateForBlock((byte) MidasLZ4Stream.MAGIC,
                compressed + 9, pointer, compressedBlock, compressed);
        dataWrapper.write(checksum.asBytes());
        dataWrapper.writeByte(MidasLZ4Stream.MAGIC);
