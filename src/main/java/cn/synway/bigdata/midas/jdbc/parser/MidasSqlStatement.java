...
public class MidasSqlStatement {
    ...
    public MidasSqlStatement(String sql) {
        this(sql, StatementType.UNKNOWN, null, null, null, null, null, null, null);
    }

    public MidasSqlStatement(String sql, StatementType stmtType) {
        this(sql, stmtType, null, null, null, null, null, null, null);
    }

    public MidasSqlStatement(String sql, StatementType stmtType, String cluster, String database, String table,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MidasSqlStatement other = (MidasSqlStatement) obj;
        if (cluster == null) {
